...
<div class="event-form-when" id="em-form-when">
	<span class="em-ec-rsvp-date-normal">
		<span class="em-date-single">
			<input id="em-ec-rsvp-date-loc" class="em-ec-rsvp-input-loc" type="text" />
			<input id="em-ec-rsvp-date" class="em-date-input" type="hidden" name="event_ec_rsvp_date" value="<?php echo $EM_Event->event_rsvp_date; ?>" />
		</span>
	</span>
